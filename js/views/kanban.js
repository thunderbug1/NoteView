...
const KanbanView = {
    ...
    renderTaskCard(task, depth = 0, isOrphaned = false) {
        ...
        // Send to vault button — always shown
        actionBtns += `<button class="kanban-action-btn" data-action="sendtovault" title="Send to vault"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path><line x1="12" y1="19" x2="12" y2="11"></line><polyline points="8 15 12 11 16 15"></polyline></svg></button>`;
        ...
        card.querySelectorAll('.kanban-action-btn').forEach(btn => {
            btn.addEventListener('click', (e) => {
                ...
                if (action === 'sendtovault') {
                    SendToVault.show(card.dataset.blockId, btn);
                }
